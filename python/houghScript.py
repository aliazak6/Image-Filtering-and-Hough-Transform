...
datadir    = os.path.join(dirname, '../data')      # the directory containing the images
resultsdir = os.path.join(dirname, '../results')   # the directory for dumping results
...
for file in os.listdir(datadir):
    if file.endswith('.jpg'):
        ...
        #lines = myHoughLineSegments(thetaScale,rhoScale,rhos, thetas, img_threshold)
